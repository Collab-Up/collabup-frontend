...
class ProjectAdapter(
    ...
    class ProjectViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val description: TextView = itemView.findViewById(R.id.project_description)
        val domainsChipGroup: ChipGroup = itemView.findViewById(R.id.projectDomainsChipGroup)
        val skillsChipGroup: ChipGroup = itemView.findViewById(R.id.projectSkillsChipGroup)
    }
    ...
    override fun onBindViewHolder(holder: ProjectViewHolder, position: Int) {
        ...
        technologies.take(3).forEachIndexed { index, technology ->
            val chip = Chip(holder.itemView.context)
